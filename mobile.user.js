// ==UserScript==
// @name         Minimalist Focus (v2.0 - Enhanced)
// @version      2.0
// @description  Performance optimized with PiP, volume control and progress bar
// @author       Admin
// @match        *://*/*
// @exclude      *://*.youtube.com/*
// @grant        GM_openInTab
...
(function() {
    ...
    function injectButton(video) {
        ...
        const btnPadding = isMobile ? '10px 14px' : '4px 8px';
    ...
    function launchFocus(video) {
        ...
        // if no PiP support than we don't need this button
        ...
        video.play().catch(() => {
            if (isMobile) {
                // you must touch warning
                const tapMsg = document.createElement('div');
                tapMsg.innerText = '▶ Tap to play';
